        ...
        <nav class="navbar navbar-expand-lg" style="background-color:rgba(255, 255, 255, 0.87);">
          ...
          <body class="p-3 mb-2 text-white">
            ...
            <div class="p-3 mb-2 text-white">
             <br><br><br><br>
             <form class="form" action="/cadastroUsuario" method="POST">
               ...
               <div class="btn">
                 <button class="button1" >
                   <a href="" class="button2">Enviar</a>
                 </button>
                 <a href="../Modelo/Cadastrar.php" class="button2">Cadastrar</a>
               </div>
                <a href="../Modelo/EsqueciSenha.html" class="button3">Esqueceu a Senha?</a>
               <div class="btn">
                 <a href="../Modelo/adm.php" class="button2">Administrador</a>
