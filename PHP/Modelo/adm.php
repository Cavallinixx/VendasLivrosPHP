...
<head>
    ...
    <body class="" style="background-image: url(../Modelo/Imagens/fundo\ verde.jpg);">
        <nav class="navbar navbar-expand-lg" style="background-color:rgba(255, 255, 255, 0.87);">
          ...
          <br><br><br><br><br><br>
          <form class="form" action="/loginUsuario" method="POST">
            <p id="heading">Login ADM</p>
            <div class="field">
              <svg
                viewBox="0 0 16 16"
                fill="currentColor"
            ...
            <div class="btn">
              <button class="button1" >
                <a href="../Modelo/crud.html" class="button2">Enviar</a>
              </button>
            </div>
            <p class="signin">Não tem uma conta ? <a href="../Modelo/Cadastrar.php">Criar</a> </p>
                </form>
             <br>
             <br>
             <br>
